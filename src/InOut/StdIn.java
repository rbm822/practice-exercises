package InOut; /******************************************************************************
 *  Compilation:  javac InOut.StdIn.java
 *  Execution:    java InOut.StdIn   (interactive test of basic functionality)
 *  Dependencies: none
 *
...
/**
 *  The {@code InOut.StdIn} class provides static methods for reading strings
 ...
 *  <p>
 *  <b>Getting started.</b>
 *  To use this class, you must have {@code InOut.StdIn.class} in your
 *  Java classpath. If you used our autoinstaller, you should be all set.
 *  Otherwise, either download
 *  <a href = "https://introcs.cs.princeton.edu/java/code/stdlib.jar">stdlib.jar</a>
 *  and add to your Java classpath or download
 *  <a href = "https://introcs.cs.princeton.edu/java/stdlib/StdIn.java">InOut.StdIn.java</a>
 ...
 *  <pre>
 *  while (!InOut.StdIn.isEmpty()) {
 *      double value = InOut.StdIn.readDouble();
 *      InOut.StdOut.println(value);
 *  }
 *  </pre>
 *  <p>
 ...
 *  <pre>
 *  while (InOut.StdIn.hasNextChar()) {
 *      char c = InOut.StdIn.readChar();
 *      InOut.StdOut.print(c);
 *  }
 *  </pre>
 *  <p>
 ...
 *  <pre>
 *  while (InOut.StdIn.hasNextLine()) {
 *      String line = InOut.StdIn.readLine();
 *      InOut.StdOut.println(line);
 *  }
 *  </pre>
 *  <p>
 ...
 *  <pre>
 *  String[] words = InOut.StdIn.readAllStrings();
 *  </pre>
 *  <p>
 *  <b>Differences with Scanner.</b>
 *  {@code InOut.StdIn} and {@link Scanner} are both designed to parse
 *  tokens and convert them to primitive types and strings.
 *  The main differences are summarized below:
 *  <ul>
 *  <li> {@code InOut.StdIn} is a set of static methods and reads
 ...
 *       and sockets.
 *  <li> {@code InOut.StdIn} uses whitespace as the delimiter pattern
 *       that separates tokens.
 *       {@link Scanner} supports arbitrary delimiter patterns.
 *  <li> {@code InOut.StdIn} coerces the character-set encoding to UTF-8,
 *       which is the most widely used character encoding for Unicode.
 *  <li> {@code InOut.StdIn} coerces the locale to {@link Locale#US},
 *       for consistency with {@link StdOut}, {@link Double#parseDouble(String)},
 *       and floating-point literals.
 *  <li> {@code InOut.StdIn} has convenient methods for reading a single
 *       character; reading in sequences of integers, doubles, or strings;
 *       and reading in all of the remaining input.
 *  </ul>
 *  <p>
 *  Historical note: {@code InOut.StdIn} preceded {@code Scanner}; when
 ...
 *  Windows, and Linux.
 *  The methods in {@code InOut.StdIn} are <em>blocking</em>, which means that they
 ...
 *  If the input begins with the optional byte-order mask, {@code InOut.StdIn}
...
public final class StdIn {
    ...
    /*** begin: section (1 of 2) of code duplicated from In to InOut.StdIn. */
    ...
    /*** end: section (1 of 2) of code duplicated from In to InOut.StdIn. */
    ...
    //// begin: section (2 of 2) of code duplicated from In to InOut.StdIn,
    ...
    //// end: section (2 of 2) of code duplicated from In to InOut.StdIn


    // do this once when InOut.StdIn is initialized
    static {
        resync();
    }

    /**
     * If InOut.StdIn changes, use this to reinitialize the scanner.
     */
